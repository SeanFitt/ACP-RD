...
class DataTrainingArguments:
    ...
    do_active_learning:Optional[bool] = field(
        default=False,
        metadata={
            "help": "Perform active learning or not."
        }
    )
    active_budget:Optional[int] = field(
        default=100,
        metadata={
            "help": "Total labeled data capacity."
        }
    )
    per_active_budget:Optional[int] = field(
        default=50,
        metadata={
            "help": "Total labeled data capacity."
        }
    ...
    device:Optional[str] = field(
        default='mps',
        metadata={
            "help": "Train on M1 device."
        }
    )
    init_set:Optional[int] = field(
        default=50,
        metadata={
            "help": "Active initial set size."
        }
    )
